...
This service continuously fetches historical price data from Pyth Network and updates the SUI, DEEP, and USDC price oracle contracts on your localnet. It runs every 10 seconds to keep prices up-to-date for testing DeepBook margin trading features.
...
- 🎯 **SUI, DEEP & USDC**: Updates all three price feeds simultaneously
...
The `price_info.price_feed.price.timestamp` field should update every 10 seconds.
